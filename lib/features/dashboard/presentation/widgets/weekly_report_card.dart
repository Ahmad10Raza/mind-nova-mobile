                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: DashboardTheme.heading3.copyWith(color: Colors.white),
                                ),
                              ],
                            ),
                          ),
                            ...
                            SnackBar(
                              content: Row(
                                children: [
                                  ...
                                  const SizedBox(width: 12),
                                  Text('Insights successfully updated!', style: DashboardTheme.bodyRegular.copyWith(color: Colors.white)),
                                ],
                              ),
              ...
              InkWell(
                onTap: () async {
                  ...
                  try {
                        ...
                        SnackBar(
                          content: Row(
                            children: [
                              const Icon(Icons.auto_awesome_rounded, color: Colors.white, size: 20),
                              const SizedBox(width: 12),
                              Text('Report generated successfully!', style: DashboardTheme.bodyRegular.copyWith(color: Colors.white)),
                            ],
                          ),
                          backgroundColor: const Color(0xFF7C4DFF),
                          behavior: SnackBarBehavior.floating,
                    ...
                    if (context.mounted) Navigator.of(context, rootNavigator: true).pop(); // Close dialog
                    if (context.mounted) {
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Failed to generate: ${e.toString()}'), backgroundColor: Colors.red));
                    }
                  }
                },
                child: Container(
